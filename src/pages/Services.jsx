...
export default function Services(){
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-2xl font-bold text-vbTeal">Featured Services</h1>
      ...
      <div className="mt-8 grid md:grid-cols-2 gap-6">
        ...
        <div id="rentals" className="rounded-2xl border p-6 bg-white/90">
      ...
      <div className="mt-4"><MembershipTable /></div>
    </div>
  )
}
