...
export default function Events() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      {loading && <div className="mt-6"><Spinner label="Loading events" /></div>}
      {error && <div className="mt-6 text-red-600">Could not load events. Please try again later.</div>}
      {!loading && !error && events.length === 0 && (
        <div className="mt-6 text-slate-600">No upcoming events found right now.</div>
      )}
